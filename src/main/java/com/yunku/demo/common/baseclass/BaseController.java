...
//    }
    ...
    protected ResponseEntity<InputStreamResource> renderFile(String fileName, String filePath) throws ServiceException {
        try {
            FileInputStream inputStream = new FileInputStream(filePath);
            return this.renderFile(fileName, (InputStream)inputStream);
        } catch (FileNotFoundException var4) {
            throw new ServiceException(String.valueOf(CoreExceptionEnum.FILE_READING_ERROR));
        }
    }
